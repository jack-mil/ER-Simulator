 ...
 * </ul>
 * Patients in a Java PriorityQueue will order themselves by urgency level and arrival
 * time.
 * Level 4 Patiens will always get precedence before others, regardless of arrival time.
 */
public class Patient implements Comparable<Patient> {
    ...
    private double calcWeight() {
        ...
        // Temporary implmentation, will probably be tweaked after testing
        // Right now, the equation values level over arrival time
        final double P1 = 0.6;
        final double P2 = 0.4;
        return (P1 * getLevel() / 4) + (P2 * 1 / arrivalTime);
    }

    /** The equals method wich may be needed (or not)
    ...
    /** String representation of a Patient. Useful in debugging
